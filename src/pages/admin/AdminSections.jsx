    ...
    <div className="fu">
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 28 }}>
        <div>
          ...
          <p className="section-sub">{PRODUCTS.length} items in catalogue</p>
        </div>
        <Btn v="primary">+ Add Product</Btn>
      </div>
      ...
      <div style={{ background: "var(--card)", border: "1px solid var(--border)", borderRadius: 10, padding: 28 }}>
        ...
        <table className="tbl">
          ...
          <tbody>
            {items.map((p) => (
              <tr key={p.id}>
                <td style={{ fontSize: 28, width: 50, textAlign: "center" }}>{p.emoji}</td>
                ...
                <td>
                  <div style={{ display: "flex", gap: 6 }}>
                    ...
                    <button style={{ padding: "5px 12px", borderRadius: 5, border: "1px solid rgba(192,57,43,.3)", background: "none", color: "var(--rose)", cursor: "pointer", fontSize: 11, fontFamily: "'Jost', sans-serif" }}>
                      Del
                    </button>
                  </div>
                </td>
